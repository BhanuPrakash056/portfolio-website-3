          ...
          >
            ...
            >
              {Array.from({ length: 8 }).map((_, i) => (
                ...
                >
                  <div className="from-primary/60 absolute top-0 left-1/2 h-1/2 w-2 -translate-x-1/2 bg-gradient-to-b to-transparent blur-sm" />
                </motion.div>
              ))}
            </motion.div>
            ...
            >
              <motion.div
                className="from-primary/30 to-accent/30 h-32 w-32 rounded-full bg-gradient-to-br blur-xl"
                animate={{
                  scale: [1, 1.3, 1],
                  opacity: [0.3, 0.6, 0.3],
                }}
            ...
            {/* Main Content */}
            <motion.div
              className="relative z-30 space-y-8 px-4 text-center"
              exit={{
                y: -30,
                opacity: 0,
                scale: 0.95,
            ...
            >
              ...
              >
                <div className="border-primary/30 relative h-12 overflow-hidden rounded-sm border-2 bg-black/50">
                  {/* Film Sprocket Holes */}
                  <div className="absolute inset-y-0 right-0 left-0 flex items-center justify-between px-2">
                    {Array.from({ length: 12 }).map((_, i) => (
                      <div key={i} className="bg-primary/20 h-2 w-1.5 rounded-sm" />
                    ))}
                  </div>

                  {/* Progress Fill */}
                  <motion.div
                    className="from-primary/40 via-accent/40 to-primary/40 absolute inset-0 bg-gradient-to-r"
                    initial={{ width: 0 }}
                    animate={{
                      width: `${progress}%`,
                      backgroundPosition: ["0% 50%", "100% 50%", "0% 50%"],
              ...
              >
                <div className="flex items-center gap-2">
                  <span className="font-mono text-gray-500">ƒ/</span>
                  <motion.span
